<main>
    ...
    <section class="ms-banner2-area fix">
        <div class="ms-banner2-wrap ms-banner2-height p-relative ms-bg"
             data-background="<?= URL?>/views/public/assets/img/banner/banner-thumb-02.jpg">
            <div class="ms-banner2-shape p-absolute"></div>
            <div class="ms-banner2-cover-img p-absolute">
                <img src="<?= URL?>/views/public/assets/img/banner/banner-thumb-03.png" alt="banner">
            </div>
            <h2 class="ms-banner2-title">Flora</h2>
            <div class="ms-banner2-video mb-10">
                <a href="https://www.youtube.com/watch?v=Rf9flQISwok" class="popup-video ms-banner2-video-btn">
                    <img class="ms-rotation-360" src="<?= URL?>/views/public/assets/img/banner/banner-border.png" alt="banner">
                    <span>play</span>
                </a>
            </div>
        </div>
    ...
    <section class="ms-find-musician pt-30 ">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xxl-10">
                    <div class="ms-find-musician-wrap">
                        <h2 class="ms-find-musician-title mb-65 text-center bd-title-anim">Phrase <span
                                class="ms-text-gradient1">d'accroche </span>
                            <span class="ms-color-1">ou</span> <span class="ms-text-gradient2">citation</span> sur
                            <br>
                            la musique
                        </h2>
...
<!--                        </div>-->
                ...
                <div class="swiper-container ms-song2-active fix">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="ms-song-item">
                                <div class="ms-song-img p-relative">
                                    <a href="genres-details.html"><img src="<?= URL?>/views/public/assets/img/brand-song/01.png"
                                                                       alt="brand-song"></a>
                                    <span class="ms-song-num">01</span>
                                </div>
                                <div class="ms-song-content">
                                    <h3 class="ms-song-title"><a href="genres-details.html">Evènement 1 ou Actualité</a>
                                    </h3>
                                    <span class="ms-song-text">courte description</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="ms-song-item">
                                <div class="ms-song-img p-relative">
                                    <a href="genres-details.html"><img src="<?= URL?>/views/public/assets/img/brand-song/02.png"
                                                                       alt="brand-song"></a>
                                    <span class="ms-song-num">02</span>
                                </div>
                                <div class="ms-song-content">
                                    <h3 class="ms-song-title"><a href="genres-details.html">Evènement 2</a>
                                    </h3>
                                    <span class="ms-song-text">courte description</span>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="ms-song-item">
                                <div class="ms-song-img p-relative">
                                    <a href="genres-details.html"><img src="<?= URL?>/views/public/assets/img/brand-song/03.png"
                                                                       alt="brand-song"></a>
                                    <span class="ms-song-num">03</span>
                                </div>
                                <div class="ms-song-content">
                                    <h3 class="ms-song-title"><a href="genres-details.html">Evènement 3</a></h3>
                                    <span class="ms-song-text">courte description</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="ms-song-item">
                                <div class="ms-song-img p-relative">
                                    <a href="genres-details.html"><img src="<?= URL?>/views/public/assets/img/brand-song/04.png"
                                                                       alt="brand-song"></a>
                                    <span class="ms-song-num">04</span>
                                </div>
                                <div class="ms-song-content">
                                    <h3 class="ms-song-title"><a href="genres-details.html">Evènement 4</a></h3>
                                    <span class="ms-song-text">courte description</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="ms-song-item">
                                <div class="ms-song-img p-relative">
                                    <a href="genres-details.html"><img src="<?= URL?>/views/public/assets/img/brand-song/05.png"
                                                                       alt="brand-song"></a>
                                    <span class="ms-song-num">05</span>
                                </div>
                                <div class="ms-song-content">
                                    <h3 class="ms-song-title"><a href="genres-details.html">Evènement 5</a>
                                    </h3>
                                    <span class="ms-song-text">courte description</span>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="ms-song-item">
                                <div class="ms-song-img p-relative">
                                    <a href="genres-details.html"><img src="<?= URL?>/views/public/assets/img/brand-song/06.png"
                                                                       alt="brand-song"></a>
                                    <span class="ms-song-num">06</span>
                                </div>
                                <div class="ms-song-content">
                                    <h3 class="ms-song-title"><a href="genres-details.html">Evènement 6</a>
                                    </h3>
                                    <span class="ms-song-text">courte description</span>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="ms-song-item">
                                <div class="ms-song-img p-relative">
                                    <a href="genres-details.html"><img src="<?= URL?>/views/public/assets/img/brand-song/07.png"
                                                                       alt="brand-song"></a>
                                    <span class="ms-song-num">07</span>
                                </div>
                                <div class="ms-song-content">
                                    <h3 class="ms-song-title"><a href="genres-details.html">Evènement è</a></h3>
                                    <span class="ms-song-text">courte description</span>
                                </div>
                            </div>
                        </div>
    ...
    <section class="work__area ms-bg-2 pt-130 pb-60 p-relative">
        <img class="work__vactor-shape d-none d-xl-block" src="<?= URL?>/views/public/assets/img/work/vector-shape-2.png"
             alt="vector shape">
        <div class="container">
                    ...
                    <div class="work__thumb-wrapper zindex-1 p-relative mb-60 d-inline-block">
                        <div class="work__thumb-inner p-relative zindex-5">
                            <div class="work__thumb m-img">
                                <img src="<?= URL?>/views/public/assets/img/work/work-thumb-04.png" alt="work image">
                            </div>
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="work__content-wrapper work__content-wrapper-space mb-70">
                        <div class="section__title-wrapper mb-50 bd-title-anim">
                            <span class="section__subtitle">Qui suis-je ?</span>
                            <h2 class="section__title two">
                                Phrase d'accroche sur l'artiste
<!--                                <span class="animated-underline active">bookin</span>-->
                            </h2>
                        </div>
                            ...
                            <div class="work__features-bottom">
                                <div class="work__features-action">
                                    <div class="work__features-btn">
                                        <a class="unfill__btn" href="contact.html">Contactez-moi</a>
                                    </div>
                                    <div class="features__btn-text">
                                        <span>Réserver quelque chose<br> avec moi!</span>
                                    </div>
                                </div>
                                <div class="work__features-arrow">
                                    <img src="<?= URL?>/views/public/assets/img/work/arrow.png" alt="image not found">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Trending area start -->
    <section class="trending__area p-relative fix pt-30 include__bg pb-30"
             data-background="<?= URL?>/views/public/assets/img/trending/tranding-bg.png">
        <div class="ms-overlay ms-overlay4 p-absolute"></div>
        <div class="container">
            <div class="row align-items-end mb-25 bdFadeUp ">
                <div class="col-lg-8">
                    <div class="section__title-wrapper mb-40 bd-title-anim">
                        <span class="section__subtitle">Ma musique</span>
...
<!--                            genres</h2>-->
                ...
                <div class="col-lg-4">
                    <div class="trending-btn mb-40 d-flex justify-content-lg-end">
                        <a class="border__btn zindex-5" href="">Tout voir</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="ms-trending2-item fix">
                            ...
                            <span class="trending__title">Flora</span>
                            <div class="trending__price">
                                <span>Pare</span>
                            </div>
                            <div class="ms-trending2-img w-img">
                                <a href="genres-details.html"><img src="<?= URL?>/views/public/assets/img/trending/07.jpg"
                                                                   alt="trending image"></a>
                            </div>
                            <div class="ms-trending2-content">
                                <div class="ms-trending2-shape">
                                    <img src="<?= URL?>/views/public/assets/img/trending/trending-shape.png" alt="trending shape">
                                </div>
                                <div class="ms-trending2-title-wrap">
                                    <a class="ms-trending2-title p-relative ms-title-border"
                                       href="">Music 1
                                        </a>
                                    <a class="ms-round-btn popup-image" href="<?= URL?>/views/public/assets/img/trending/07.jpg"><i
...
<!--                            <a href="genres-details.html"><img src="--><?//= URL?><!--/views/public/assets/img/function-brand/function-brand-01.png"-->
...
<!--                    <div class="ms-fun-brand-top mb-20">-->
<!--                        <div class="ms-fun-brand-thumb">-->
<!--                            <a href="genres-details.html"><img src="--><?//= URL?><!--/views/public/assets/img/function-brand/function-brand-02.png"-->
<!--                                                               alt="function brand"></a>-->
<!--                        </div>-->
<!--                        <div class="ms-fun-brand-content">-->
...
<!--                    <div class="ms-fun-brand-top mb-20">-->
<!--                        <div class="ms-fun-brand-thumb">-->
<!--                            <a href="genres-details.html"><img src="--><?//= URL?><!--/views/public/assets/img/function-brand/function-brand-03.png"-->
<!--                                                               alt="function brand"></a>-->
<!--                        </div>-->
<!--                        <div class="ms-fun-brand-content">-->
...
<!--                    <div class="ms-fun-brand-top mb-20">-->
<!--                        <div class="ms-fun-brand-thumb">-->
<!--                            <a href="genres-details.html"><img src="--><?//= URL?><!--/views/public/assets/img/function-brand/function-brand-04.png"-->
<!--                                                               alt="function brand"></a>-->
<!--                        </div>-->
<!--                        <div class="ms-fun-brand-content">-->
...
<!--                    <div class="ms-fun-brand-top mb-20">-->
<!--                        <div class="ms-fun-brand-thumb">-->
<!--                            <a href="genres-details.html"><img src="--><?//= URL?><!--/views/public/assets/img/function-brand/function-brand-05.png"-->
<!--                                                               alt="function brand"></a>-->
<!--                        </div>-->
<!--                        <div class="ms-fun-brand-content">-->
<!--                            <h3 class="ms-fun-brand-title"><a href="genres-details.html">Beastie Boys</a>-->
...
<!--                    <div class="ms-fun-brand-top mb-20">-->
<!--                        <div class="ms-fun-brand-thumb">-->
<!--                            <a href="genres-details.html"><img src="--><?//= URL?><!--/views/public/assets/img/function-brand/function-brand-06.png"-->
<!--                                                               alt="function brand"></a>-->
<!--                        </div>-->
<!--                        <div class="ms-fun-brand-content">-->
<!--                            <h3 class="ms-fun-brand-title"><a href="genres-details.html">Blondie</a></h3>-->
...
<!--                    <div class="ms-fun-brand-top mb-20">-->
<!--                        <div class="ms-fun-brand-thumb">-->
<!--                            <a href="genres-details.html"><img src="--><?//= URL?><!--/views/public/assets/img/function-brand/function-brand-07.png"-->
<!--                                                               alt="function brand"></a>-->
<!--                        </div>-->
<!--                        <div class="ms-fun-brand-content">-->
<!--                            <h3 class="ms-fun-brand-title"><a href="genres-details.html">Black Sabbath</a>-->
...
<!--                    <div class="ms-fun-brand-top mb-20">-->
<!--                        <div class="ms-fun-brand-thumb">-->
<!--                            <a href="genres-details.html"><img src="--><?//= URL?><!--/views/public/assets/img/function-brand/function-brand-08.png"-->
<!--                                                               alt="function brand"></a>-->
<!--                        </div>-->
<!--                        <div class="ms-fun-brand-content">-->
<!--                            <h3 class="ms-fun-brand-title"><a href="genres-details.html">The Coasters</a>-->
...
<!--    </section>-->
            ...
            <div class="row align-items-center bdFadeUp">
                <div class="col-xl-6">
                    <div class="ms-app-left mb-45">
                        <div class="section__title-wrapper mb-40 bd-title-anim">
                            <span class="section__subtitle">Streaming</span>
                            <h2 class="section__title">Retrouvez moi sur toutes <span class="animated-underline active"> les plateformes
                                        streaming</span>
                            </h2>
                        </div>
                        <p class="ms-app-text mb-65">Ecoutez en illimité ma musique en streaming</p>
                        <div class="ms-app-inner ms-app-list ms-app-opacity">
                            <a href="#" target="_blank"><img src="<?= URL?>/views/public/assets/img/cta/app-store.png" alt="app store"></a>
                            <a href="#" class="active" target="_blank"><img src="<?= URL?>/views/public/assets/img/cta/amazonmusic.png"
                                                                            alt="amazon music"></a>
                            <a href="#" target="_blank"><img src="<?= URL?>/views/public/assets/img/cta/play-store.png"
                                                             alt="play store"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="ms-app-right m-img mb-60">
                        <img src="<?= URL?>/views/public/assets/img/bg/app-cricle-bg.png" alt="app circle">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="ms-event2-area include__bg zindex-1 p-relative pt-140 pb-105"
             data-background="<?= URL?>/views/public/assets/img/event/event-bg-3.png">
...
<!--                        </div>-->
                        <div class="section__title-wrapper mb-40 bd-title-anim">
                            <span class="section__subtitle">Evènements à venir</span>
                            <h2 class="section__title">Retrouvez moi <span class="animated-underline active">à ces evènements</span></h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row bdFadeUp">
                <div class="col-lg-6">
                    <div class="ms-event2-item mb-25">
                        <h3 class="ms-event-title"><a href="event-details.html">Evènement 1
                                </a></h3>
                        <p class="ms-event-text">Description</p>
                        <div class="ms-event-inner">
                            <div class="ms-event-location">
                                <a href="https://www.google.com/maps" target="_blank" tabindex="0"><i
                                        class="flaticon-pin"></i>Lieu</a>
                            </div>
                            <div class="ms-event-date">
                                <span>Heure, jour/mois/annee</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="ms-event2-item mb-25">
                        <h3 class="ms-event-title"><a href="event-details.html">Evènement 2
                            </a></h3>
                        <p class="ms-event-text">Description</p>
                        <div class="ms-event-inner">
                            <div class="ms-event-location">
                ...
                <div class="col-lg-6">
                    <div class="ms-event2-item mb-25">
                        <h3 class="ms-event-title"><a href="event-details.html">Evènement 3
                            </a></h3>
                        <p class="ms-event-text">Description</p>
                        <div class="ms-event-inner">
                            <div class="ms-event-location">
                ...
                <div class="col-lg-6">
                    <div class="ms-event2-item mb-25">
                        <h3 class="ms-event-title"><a href="event-details.html">Evènement 4
                            </a></h3>
                        <p class="ms-event-text">Description</p>
                        <div class="ms-event-inner">
                            <div class="ms-event-location">
    ...
    <section class="ms-tm2-area p-relative fix pt-130 pb-130">
        <div class="ms-tm2-line p-absolute">
            <img src="<?= URL?>/views/public/assets/img/testimonial/testimonial-line.png" alt="testimonial line">
        </div>
        <div class="container">
            <div class="row justify-content-center bdFadeUp">
                <div class="col-xl-6">
                    <div class="section__title-wrapper text-center mb-65 bd-title-anim">
                        <span class="section__subtitle">Témoignage</span>
                        <h2 class="section__title">Ce qu'ils disent <span class="animated-underline active"> moi
                                </span>
                        </h2>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="ms-tm2-imgs-wrap p-relative">
                <div class="ms-tm2-img1 ms-tm2-shadow p-absolute w-img d-none d-md-block">
                    <img src="<?= URL?>/views/public/assets/img/testimonial/testimonial-07.png" alt="testimonial image">
                </div>
                <div class="ms-tm2-img2 ms-tm2-shadow p-absolute w-img d-none d-lg-block">
                    <img src="<?= URL?>/views/public/assets/img/testimonial/testimonial-08.png" alt="testimonial image">
                </div>
                <div class="ms-tm2-img3 ms-tm2-shadow p-absolute w-img d-none d-xl-block">
                    <img src="<?= URL?>/views/public/assets/img/testimonial/testimonial-09.png" alt="testimonial image">
                </div>
                <div class="ms-tm2-img4 ms-tm2-shadow p-absolute w-img d-none d-md-block">
                    <img src="<?= URL?>/views/public/assets/img/testimonial/testimonial-10.png" alt="testimonial image">
                </div>
                <div class="ms-tm2-img5 ms-tm2-shadow p-absolute w-img d-none d-lg-block">
                    <img src="<?= URL?>/views/public/assets/img/testimonial/testimonial-11.png" alt="testimonial image">
                </div>
                <div class="ms-tm2-img6 ms-tm2-shadow p-absolute w-img d-none d-xl-block">
                    <img src="<?= URL?>/views/public/assets/img/testimonial/testimonial-12.png" alt="testimonial image">
                </div>
                <div class="row justify-content-center bdFadeUp">
                    <div class="col-xl-8">
                                    ...
                                    <div class="ms-tm2-img-main">
                                        <div class="ms-tm2-img-wrap p-relative d-inline-block mx-auto">
                                            <div class="ms-tm2-signature w-img">
                                                <img src="<?= URL?>/views/public/assets/img/testimonial/testimonial-signature.png"
                                                     alt="testimonial signature">
                                            </div>
                                            <div class="ms-tm2-author-img m-img">
                                                <img src=" <?= URL?>/views/public/assets/img/testimonial/testimonial-06.png"
                                        ...
                                        <div class="ms-tm2-content pt-35">
                                            ...
                                            <p class="ms-tm2-text mb-30">Témoignage 1</p>
                                            <div class="ms-tm2-author">
                                                <span class="ms-tm2-name">Nom prénoms</span>
                                                <span class="ms-tm2-designation">Fonction structure</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="ms-news-area ms-bg-2 pt-130 pb-90">
        <div class="container">
            <div class="row justify-content-center bdFadeUp">
                <div class="col-xl-6">
                    <div class="section__title-wrapper text-center mb-65 bd-title-anim">
                        <span class="section__subtitle">Actualité</span>
                        <h2 class="section__title">Dernières <span class="animated-underline active">
                                    Nouvelles</span>
                        </h2>
                    </div>
                </div>
            ...
            <div class="row bdFadeUp">
                <div class="col-xl-4 col-md-6">
                    <div class="ms-news-item p-relative zindex-1 mb-40">
                        ...
                        <div class="ms-news-thumb w-img">
                            <a href="news-details.html"><img src="<?= URL?>/views/public/assets/img/news/news-01.png" alt="news image"></a>
                        </div>
                        <div class="ms-news-content ms-news-position p-absolute">
                            <a class="ms-news2-cat mb-30" href="news-details.html">Catégorie</a>
                            <h3 class="ms-news-title mb-15"><a href="news-details.html">Phrase introductive</a></h3>
                            <div class="ms-news-meta d-inline-block">
                                <span>Date de publication</span>
                                <span><a href="news-details.html">0 Commentaire</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="ms-news-item p-relative zindex-1 mb-40">
                        <div class="ms-news-overlay p-absolute"></div>
                        <div class="ms-news-thumb w-img">
                            <a href="news-details.html"><img src="<?= URL?>/views/public/assets/img/news/news-02.png" alt="news image"></a>
                        </div>
                        <div class="ms-news-content ms-news-position p-absolute">
                            <a class="ms-news2-cat mb-30" href="news-details.html">Catégorie</a>
                            <h3 class="ms-news-title mb-15"><a href="news-details.html">Phrase introductive</a></h3>
                            <div class="ms-news-meta d-inline-block">
                                ...
                                <span><a href="news-details.html">10 Commentaires</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="ms-news-item p-relative zindex-1 mb-40">
                        <div class="ms-news-overlay p-absolute"></div>
                        <div class="ms-news-thumb w-img">
                            <a href="news-details.html"><img src="<?= URL?>/views/public/assets/img/news/news-03.png" alt="news image"></a>
                        </div>
                        <div class="ms-news-content ms-news-position p-absolute">
                            <a class="ms-news2-cat mb-30" href="news-details.html">Catégorie</a>
                            <h3 class="ms-news-title mb-15"><a href="news-details.html">Phrase introductive</a></h3>
                            <div class="ms-news-meta d-inline-block">
                                ...
                                <span><a href="news-details.html">14 Commentaires</a></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--                                                        src="--><?//= URL?><!--/views/public/assets/img/popular/popular-01.png"-->
<!--                                                        alt="popular band"></a>-->
...
<!--                                                <div class="ms-popular-overlay"></div>-->
<!--                                                <a href="genres-details.html"><img-->
<!--                                                        src="--><?//= URL?><!--/views/public/assets/img/popular/popular-02.png"-->
<!--                                                        alt="popular band"></a>-->
<!--                                                <a href="genres-details.html" class="ms-popular__link">-->
<!--                                                        <span class="ms-popular-icon"><i-->
<!--                                                                class="fa-regular fa-arrow-right-long"></i></span>-->
...
<!--                                                <div class="ms-popular-overlay"></div>-->
<!--                                                <a href="genres-details.html"><img-->
<!--                                                        src="--><?//= URL?><!--/views/public/assets/img/popular/popular-03.png"-->
<!--                                                        alt="popular band"></a>-->
<!--                                                <a href="genres-details.html" class="ms-popular__link">-->
<!--                                                        <span class="ms-popular-icon"><i-->
<!--                                                                class="fa-regular fa-arrow-right-long"></i></span>-->
...
<!--                                                <div class="ms-popular-overlay"></div>-->
<!--                                                <a href="genres-details.html"><img-->
<!--                                                        src="--><?//= URL?><!--/views/public/assets/img/popular/popular-04.png"-->
<!--                                                        alt="popular band"></a>-->
<!--                                                <a href="genres-details.html" class="ms-popular__link">-->
<!--                                                        <span class="ms-popular-icon"><i-->
<!--                                                                class="fa-regular fa-arrow-right-long"></i></span>-->
