            ...
            <div class="offcanvas__content">
                <div class="offcanvas__top mb-40 d-flex justify-content-between align-items-center">
                    <div class="offcanvas__logo">
                        <a href="index.html">
                            <img src="<?= URL?>/views/public/assets/img/logo/logo.svg" alt="logo">
                        </a>
                    </div>
                ...
                <div class="offcanvas__user mb-30 d-xxl-none">
                    <div class="user__acount">
                        ...
                        <div class="user__name-mail">
                            <h4 class="user__name"><a href="javascript:void(0)">Flora</a></h4>
                            <p class="user__mail">contact@florapare.bf</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="offcanvas__btn mb-30">
                    <a class="ms-border-btn" href="services.html"><i class="fa-solid fa-plus"></i> Lorem
                        </a>
                </div>
                <div class="offcanvas__social">
                    <div class="ms-footer-social mb-0">
                        <a href="https://www.linkedin.com/" title="Instagram" target="_blank">Instagram</a>
                    ...
                    <div class="mega__menu-wrapper p-relative">
                        <div class="header__main ms-border2 d-flex align-items-center justify-content-between">
                            <div class="header__logo pt-25 pb-25">
                                <a href="index.html">
                                    <img src="<?= URL?>/views/public/assets/img/logo/logo.svg" alt="logo not found">
                                </a>
                            </div>
...
<!--                                                <a href="genres.html"><img src="--><?//= URL?><!--/views/public/assets/img/genres/genres-01.jpg"-->
<!--                                                                           alt="brand-song"></a>-->
<!--                                            </div>-->
...
<!--                                        <div class="ms-song-item">-->
<!--                                            <div class="ms-song-img p-relative">-->
<!--                                                <a href="genres.html"><img src="--><?//= URL?><!--/views/public/assets/img/genres/genres-02.jpg"-->
<!--                                                                           alt="brand-song"></a>-->
<!--                                            </div>-->
<!--                                            <div class="ms-song-content">-->
...
<!--                                        <div class="ms-song-item">-->
<!--                                            <div class="ms-song-img p-relative">-->
<!--                                                <a href="genres.html"><img src="--><?//= URL?><!--/views/public/assets/img/genres/genres-03.jpg"-->
<!--                                                                           alt="brand-song"></a>-->
<!--                                            </div>-->
<!--                                            <div class="ms-song-content">-->
...
<!--                                        <div class="ms-song-item">-->
<!--                                            <div class="ms-song-img p-relative">-->
<!--                                                <a href="genres.html"><img src="--><?//= URL?><!--/views/public/assets/img/genres/genres-04.jpg"-->
<!--                                                                           alt="brand-song"></a>-->
<!--                                            </div>-->
<!--                                            <div class="ms-song-content">-->
...
<!--                                        <div class="ms-song-item">-->
<!--                                            <div class="ms-song-img p-relative">-->
<!--                                                <a href="genres.html"><img src="--><?//= URL?><!--/views/public/assets/img/genres/genres-05.jpg"-->
<!--                                                                           alt="brand-song"></a>-->
<!--                                            </div>-->
<!--                                            <div class="ms-song-content">-->
...
<!--                                                </li>-->
                                                ...
                                                <li>
                                                    <a href="work-system.html">Music</a>
                                                </li>
